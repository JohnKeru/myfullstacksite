...
import { ProfileSomeInfo, P } from '../themes'

const ProfileContent = () => {
  
    return (
        <ProfileSomeInfo className='ProfileContent'>
            <div className='insideContent'>
                <h1 id='hello'>Longest Hello Title</h1>
                <P>
                    ...
                    <i>He determined to drop his litigation with the monastry</i>, and relinguish his claims to the wood-cuting and fishery rihgts at once. He was the more ready to do this becuase the rights had becom much less valuable, and he had indeed the vaguest idea where the wood and river in quedtion were.
